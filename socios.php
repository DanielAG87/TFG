        ...
        <div class="row">
            <div class="col-md-8">
                <div class="d-flex justify-content-center">
                    ...
                    <button class="btn btn-outline-primary busSocio" type="button" name="modBuscarSocio" id="modBuscarSocio" onclick="buscarSocio()">Buscar socio</button>
                </div>
